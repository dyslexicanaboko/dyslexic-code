...
namespace Beefball.Entities
{
	public partial class ScoreHud : PositionedObject, IDestroyable
	{
		...
		protected virtual void InitializeEntity(bool addToManagers)
		{
			...
			Team1Score = EntireScene.Texts.FindByName("Team1Score");
			Team1Score.AdjustPositionForPixelPerfectDrawing = true;
			Team2Score = EntireScene.Texts.FindByName("Team2Score");
			Team2Score.AdjustPositionForPixelPerfectDrawing = true;
