...
namespace PongExample.Entities
{
	public partial class Paddle : PositionedObject, IDestroyable, FlatRedBall.Math.Geometry.ICollidable
	{
		...
		public FlatRedBall.Math.Geometry.RepositionDirections AxisAlignedRectangleInstanceRepositionDirections
		{
			get
			{
				return AxisAlignedRectangleInstance.RepositionDirections;
			}
			set
			{
				AxisAlignedRectangleInstance.RepositionDirections = value;
			}
		}
		public Microsoft.Xna.Framework.Input.Keys MoveUpKey;
		public Microsoft.Xna.Framework.Input.Keys MoveDownKey;
        ...
        public Paddle(string contentManagerName) :
            this(contentManagerName, true)
        {
        }


        public Paddle(string contentManagerName, bool addToManagers) :
			base()
		{
			// Don't delete this:
...
// Generated AddToManagers
		...
		public virtual void AssignCustomVariables (bool callOnContainedElements)
		{
			...
			mAxisAlignedRectangleInstance.Height = 128f;
			mAxisAlignedRectangleInstance.Width = 16f;
			MovementSpeed = 150f;
			AxisAlignedRectangleInstanceRepositionDirections = FlatRedBall.Math.Geometry.RepositionDirections.All;
		}
		...
		public static void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("PaddleStaticUnload", UnloadStaticContent);
