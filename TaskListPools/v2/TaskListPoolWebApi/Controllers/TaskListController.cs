...
namespace TaskListPoolWebApi.Views.TaskList
{
    public class TaskListController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TaskId,Body,CreatedOn,IsDeleted")] Task task)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TaskId,Body,CreatedOn,IsDeleted")] Task task)
        {
            if (ModelState.IsValid)
            {
