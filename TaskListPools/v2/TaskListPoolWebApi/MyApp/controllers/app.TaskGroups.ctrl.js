(function ($, angular) {
    ...
    taskGroupsCtrl.$inject = ["$scope", "$filter", "toaster", "TaskPoolSvc", "ServerResponseHelper"];

    var _members = null;

    function taskGroupsCtrl($scope, $filter, toaster, TaskPoolSvc, ServerResponseHelper) {
        console.log("taskGroupsCtrl");
    ...
    function btnTaskGroupLists_click(taskGroupId) {
        //alert("Modal should show here.");
        //_members.$scope.showModal = true;
        //console.dir($ctrl);
        _members.$scope.$broadcast("openModalWindow", taskGroupId);
    }
